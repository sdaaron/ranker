...
最近的业余时间，我在做一个用大模型做资讯聚合的日报网站：https://Euery.cc
...
实际上线到 https://Euery.cc 的工作流有一个额外的环节，是一个简单的审核，通过敏感词匹配简单粗暴地屏蔽了一些文章。
...
![cost_image](https://github.com/sdaaron/Euery-web/blob/main/project-img/cost-screenshot.png)
