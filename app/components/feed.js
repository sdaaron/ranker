...
export default async function Example(props) {
  ...
  return (
    ...
    //   </div>
    <>
      <div className="flow-root bg-white rounded-xl z-30 mb-4 hover:bg-gradient-to-br hover:from-white hover:to-zinc-50 hover:shadow-sm hover:ring-1 hover:ring-gray-200">
